...
use super::{authentication::GameProfile, EncryptionError};
use bytes::BytesMut;
...
use tokio::{io::AsyncReadExt, net::TcpStream, select, sync::RwLock};
...
impl Client {
    ...
    pub async fn send_system_message<'a>(&mut self, text: TextComponent<'a>) {
